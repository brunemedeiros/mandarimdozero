...
// appKey identifica o namespace de cada idioma dentro da coluna jsonb
// `data` da tabela `progress` (ver APP_KEY em cada languages/<lang>/app.js)
// -- não é o mesmo valor que `id` (usado em URLs/roteamento). O Perfil
// (shared/profile.js) precisa dos dois: `id` pra achar o idioma na lista,
// `appKey` pra ler o progresso dele salvo no Supabase.
