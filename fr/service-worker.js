// Service worker do Français avec Prof. Brune — cache básico pra funcionar
// offline depois da primeira visita. Estratégia: network-first pros arquivos
...
const CACHE_NAME = 'frances-avec-prof-brune-__BUILD_ID__';
const PRECACHE_URLS = [
  './',
  './index.html',
  './app.js',
