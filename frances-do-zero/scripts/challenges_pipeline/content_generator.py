...
PROMPT_TEMPLATE = (
    ...
    "à forma canônica). A lacuna precisa cobrir a expressão INTEIRA (ou sua "
    "forma flexionada inteira) -- nunca dividir a expressão, deixando parte "
    "dela dentro da lacuna e parte escrita na frase.\n"
    "- microActivityAnswer: a resposta esperada da lacuna -- precisa ser "
    "exatamente o texto que preenche a lacuna (a expressão inteira "
    "flexionada), nunca só um pedaço dela.\n\n"
